...
export function NavFavorite(props) {
	return <div className="nav-fav nav-div">{props.icon} favorite.</div>;
}

export function NavMade(props) {
	return <div className="nav-made nav-div">{props.icon} i made it.</div>;
}
...
export function Dropdown({ setAuthenticated, authenticated }) {
	...
	function DropdownItem(props) {
		return (
			<a href="#" className="dropdown-item item" onClick={() => props.goToMenu && setActiveMenu(props.goToMenu)}>
				{props.children}
				<div>
